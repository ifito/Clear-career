...
import { getOneById, updateOneOffer } from '../data/offers.js';

const editTemplaate = (offer, onEdit) => html`
<section id="edit">
<div class="form">
  <h2>Edit Offer</h2>
...
export async function editPage(ctx) {
    ...
    ctx.render(editTemplaate(offer, createSubmitHandler(onEdit)));
